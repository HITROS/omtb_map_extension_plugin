...
rosrun map_server map_saver map:=/robot1/map -f $(rospack find omtb_map_extension_plugin)/map/zmapp_change;
rosservice call /robot1/write_state "$(rospack find omtb_map_extension_plugin)/map/zmap_change.pbstream"&&rosrun cartographer_ros cartographer_pbstream_to_ros_map -map_filestem=$(rospack find omtb_map_extension_plugin)/map/zmap_change -pbstream_filename=$(rospack find omtb_map_extension_plugin)/map/zmap_change.pbstream -resolution=0.05
